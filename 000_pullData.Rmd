...
Lastly, this table shows all the lakes with long-term data of any kind (TP, NO3, Secchi depth) as a way of seeing if/which lakes have multiple parameters. For instance, we talked about looking at changing NO3:TP ratios.

For cleaner plotting, I am only showing the lakes where we have both NO3 & TP data or all three.

```{r, echo=FALSE, message=FALSE, warning=FALSE,out.width = '100%', fig.height=10}
